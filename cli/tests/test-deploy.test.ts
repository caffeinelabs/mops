...
describe("mapPocketIcError", () => {
  ...
  test("matches the authoritative ic-error-types numeric sequence", () => {
    expect(Object.values(ICP_ERROR_CODE_NUMBERS)).toEqual([
      101, 102, 201, 202, 203, 204, 205, 206, 207, 208, 209, 210, 301, 305,
      402, 403, 404, 405, 406, 407, 408, 409, 410, 502, 503, 504, 505, 506,
      507, 508, 509, 510, 511, 512, 513, 514, 517, 520, 521, 522, 524, 525,

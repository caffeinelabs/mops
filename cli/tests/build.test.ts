...
describe("build", () => {
  ...
  test("check-deploy continues after deterministic migration inconclusive outcomes", async () => {
    const cwd = path.join(
      import.meta.dirname,

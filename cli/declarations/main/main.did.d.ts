...
export interface Main {
  ...
  'getFileHashesByPackageIds' : ActorMethod<
    [Array<PackageId>],
    Array<[PackageId, Array<[FileId, Uint8Array]>]>
  >,
  ...
  'setTelegramBotToken' : ActorMethod<[string], undefined>,
  ...
  'transformTelegramRequest' : ActorMethod<[TransformArg], HttpRequestResult>,
...
export interface StructureStats { 'count' : bigint, 'bytes' : bigint }

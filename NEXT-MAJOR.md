...
- **`@icp-sdk/core` 4.0.2 → 5.4.0 is clean** (incl. Ed25519/Secp256k1 pem decoding). But latest is 6.0.0 and pic requires `^5` — **pin 5.x** or get two `Principal`/`IDL` identities from a nested copy.
